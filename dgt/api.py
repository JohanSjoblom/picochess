...
class MessageApi:
    ...
    TUTOR_MOVE_REVEAL = "MSG_TUTOR_MOVE_REVEAL"  # BRAIN/HAND: reveal tutor's full move as green circles after user plays
...
class Message:
    ...
    TUTOR_MOVE_REVEAL = ClassFactory(MessageApi.TUTOR_MOVE_REVEAL, ["move"])  # chess.Move: tutor's full move to reveal
