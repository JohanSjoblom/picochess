...
# but not so high that depth on RPi is too shallow.
# 10 covers typical positions well, matches Arasan's MultiPV max, and allows
# deeper search per line than 30 did.  The engine layer clamps to engine max anyway.
