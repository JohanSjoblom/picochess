...
class TestSystemLoop(unittest.TestCase):
    ...
    def test_next(self):
        ...
        self.assertEqual(System.WIFI, loop.next(System.EBOARD))
        self.assertEqual(System.BLUETOOTH, loop.next(System.WIFI))
        self.assertEqual(System.THEME, loop.next(System.BLUETOOTH))
    ...
    def test_prev(self):
        ...
        self.assertEqual(System.BLUETOOTH, loop.prev(System.THEME))
        self.assertEqual(System.WIFI, loop.prev(System.BLUETOOTH))
        self.assertEqual(System.EBOARD, loop.prev(System.WIFI))
...
class TestEBoardLoop(unittest.TestCase):
    ...
    def test_next(self):
        ...
        self.assertEqual(EBoard.CITRINE, loop.next(EBoard.ICHESSONE))
        self.assertEqual(EBoard.OSA, loop.next(EBoard.CITRINE))
        self.assertEqual(EBoard.NOEBOARD, loop.next(EBoard.OSA))
    ...
    def test_prev(self):
        ...
        self.assertEqual(EBoard.OSA, loop.prev(EBoard.NOEBOARD))
        self.assertEqual(EBoard.CITRINE, loop.prev(EBoard.OSA))
        self.assertEqual(EBoard.ICHESSONE, loop.prev(EBoard.CITRINE))
